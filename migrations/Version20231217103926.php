 ...
 */
final class Version20231217103926 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE page DROP category_id, DROP template_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE page ADD category_id INT DEFAULT NULL, ADD template_id INT NOT NULL');
